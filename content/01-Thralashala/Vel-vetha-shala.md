---
title: "Vel'vetha'shala — Foundations of Biology"
...
# <span class="furling-pin">Vel'vetha'shala</span> | Foundations of Biology

> *The most remarkable thing about life is not its complexity. Complexity accumulates from simple processes given enough time. The remarkable thing is that life is self-maintaining: it actively works to persist. A rock does not resist erosion. A living cell does. It takes in energy, uses it to maintain and replicate its own structure, and produces more of itself. This is what life is, before it is anything else: the chemistry of self-continuation.*
> — Vetha Omavel-Rala, Era 88

## What Life Is

Defining life precisely is harder than it appears. The archive uses a working definition developed across several generations of debate: a living system is one that maintains its own chemical organisation against the tendency toward disorder, uses energy from its environment to do so, reproduces itself with variation, and responds to its environment.
...
All known life in the archive is cellular: composed of one or more cells, where each cell is a self-contained unit of living chemistry enclosed by a membrane.
...
The discovery that all known life shares a common basic architecture was, for the Furlings, one of the most significant findings in the history of science. It was not obvious that this would be true. Life might have arisen independently in different places using completely different chemical systems, with nothing in common except the functional property of self-continuation.
...
> [[Vethara-skela|Vethara'skela]] — how life organises into ecosystems
> [[Vel-vetha-meva|Vel'vetha'meva]] — medical foundations, which apply this biology
> [[01-Thralashala/index|Thrala'shala]] — return to the branch index
> [[Vetha-Omavel-Rala|Vetha Omavel-Rala]] — compiler of this record
