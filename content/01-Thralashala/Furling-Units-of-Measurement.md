---
title: "Furling Units of Measurement"
...
> [!record-header]
> Thrala'shala · Compiled by the Shala'vel Thara Division, across Eras 14–134 · Visitor

# <span class="furling-pin">Thael'vel'shala</span> | The Measured Sciences
...
|---|---|
| Deep ocean freeze (0 lath anchor) | 0 lath |
| Water surface freeze | ~37 lath |
...
| Unit | Definition | 
|---|---|
| **tael** | Base unit — "the small cycle" | 
| **thaeli** | 700 tael — "short period" | 
| **taelketh** | 7,000 tael — "counted period" | 
| **mira'thara** | 84,000 tael — one full rotation of Mira | 

*One mira'thara is divided into 12 taelketh. This is the standard Furling clock.*
...
| **thara'vel** | 10 thara'keth — "ten-cycles" | 
| **thara'shala** | 100 thara'keth — "wisdom-cycles" | 
...
| Term | Symbol | Derivation |
|---|---|---|
| **skela'var** | *sv* | *skela* (home) + *var* (star/light) — "home-to-star" |

Defined as the mean orbital distance of Mira from Vara. It is our equivalent of an astronomical unit, anchored to our own world rather than an external reference.

| Body | Distance |
|---|---|
| Vareth (Planet I) | 0.33 skela'var |
| Thrael (Planet II) | 0.59 skela'var |
| Mira (Planet III) | 1.00 skela'var *(by definition)* |
| Velakris (Inner Belt) | ~1.39 skela'var |
| Naiveth (Planet IV) | 2.04 skela'var |
...
| Unit | Derivation | Measures |
|---|---|---|
| **vara'keth** | *vara* + *keth* (enduring) — "Vara's substance" | Stellar mass |
| **vara'shael** | *vara* + *shael* — "Vara's measure" | Stellar radius |
| **vara'val** | *vara* + *val* (shine) — "Vara's shine" | Stellar luminosity |
...
|---|---|---|
| Length | shael | ~0.925 m |
| Volume | shelai³ | cubic shael |
| Mass | thal'keth | 1/10,000,000,000 of Mira's mass |
| Temperature | lath | 0 = deep ocean freeze on Mira |
| Time (base) | tael | ~1 second |
| Time (day) | mira'thara | 84,000 tael |
| Time (year) | thara'keth | 34,440,000 tael |
| Time (epoch) | tael'kora | 1,000,000 thara'keth |
| Orbital distance | skela'var | Mira–Vara distance |
...
> [[Varaskela-System-Data|Vara'skela — System Data Tables]] — the system whose bodies anchor most of these units
> [[Vara-Mira-shala|Vara — The Complete Record]] — the star whose measurements define the stellar units
